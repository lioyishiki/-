...
public class PayController {
    ...
    public void updatePayOrderStatusByOrderNo(@PathVariable("id") Long orderId,@PathVariable("status") Integer status){
        payOrderService.updateStatusById(orderId,status);
    }
}
